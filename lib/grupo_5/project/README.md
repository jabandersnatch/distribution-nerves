...
3. En cada RPI se deben seguir los siguientes pasos:
  - Flashear la imagen del proyecto nerves en la Raspberry Pi
  - Conectar la Raspberry Pi a la red local, mediante un cable ethernet o wifi
  - Iniciar la consola de la Raspberry Pi (comando ssh nerves.local)
  - Ejecutar las siguientes lineas de comandos en la consola de la Raspberry Pi:
      - Mix.install([:ex_png])
